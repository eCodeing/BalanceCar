...
void OLED_ShowFloat(u8 x,u8 y,float num,u8 size)
{
	...
	OLED_ShowChar(x+(size/2),y,temp/100+'0',size,1); 
	OLED_ShowChar(x+(size/2)*2,y,temp%100/10+'0',size,1); 
	OLED_ShowChar(x+(size/2)*3,y,temp%10+'0',size,1); 
	if(num_isnative)temp = (int)(((-num) - temp)*1000);
	else temp = (int)((num - temp)*1000);
	OLED_ShowChar(x+(size/2)*4,y,'.',size,1); 
	OLED_ShowChar(x+(size/2)*5,y,temp/100+'0',size,1); 
	OLED_ShowChar(x+(size/2)*6,y,temp%100/10+'0',size,1); 	
	OLED_ShowChar(x+(size/2)*7,y,temp%10+'0',size,1); 
}
//format:+/-xxx.xxx
void OLED_ShowInt(u8 x,u8 y,int num,u8 size)
{
	...
	OLED_ShowChar(x+(size/2),y,temp/1000+'0',size,1); 
	OLED_ShowChar(x+(size/2)*2,y,temp%1000/100+'0',size,1); 
	OLED_ShowChar(x+(size/2)*3,y,temp%100/10+'0',size,1); 
//	if(num_isnative)temp = (int)(((-num) - temp)*1000);
//	else temp = (int)((num - temp)*1000);
	OLED_ShowChar(x+(size/2)*4,y,temp%10+'0',size,1); 
//	OLED_ShowChar(x+(size/2)*5,y,temp/100+'0',size,1); 
//	OLED_ShowChar(x+(size/2)*6,y,temp%100/10+'0',size,1); 	
//	OLED_ShowChar(x+(size/2)*7,y,temp%10+'0',size,1); 
}
